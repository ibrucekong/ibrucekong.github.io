...
var calendar = {
  ...
  solar2lunar:function (y,m,d) { //鍙傛暟鍖洪棿1900.1.31~2100.12.31
    if(y<1900 || y>2100) {return -1;}//骞翠唤闄愬畾銆佷笂闄�
    if(y==1900&&m==1&&d<31) {return -1;}//涓嬮檺
    if(!y) { //鏈紶鍙�  鑾峰緱褰撳ぉ
    ...
    if(nWeek==0) {nWeek =7;}//鏁板瓧琛ㄧず鍛ㄥ嚑椤哄簲澶╂湞鍛ㄤ竴寮€濮嬬殑鎯緥
    //鍐滃巻骞�
    var year = i;
    ...
    var firstNode   = calendar.getTerm(year,(m*2-1));//杩斿洖褰撴湀銆岃妭銆嶄负鍑犳棩寮€濮�
    var secondNode  = calendar.getTerm(year,(m*2));//杩斿洖褰撴湀銆岃妭銆嶄负鍑犳棩寮€濮�
